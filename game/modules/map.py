...
class Map:
    ...
    def initTiles(self):
        ...
        tile26 = Tile(path+'10.png', TILES_DATA[10])
        tile27 = Tile(path+'11.png', TILES_DATA[11])
        tile28 = Tile(path+'12.png', TILES_DATA[12])
        tile29 = Tile(path+'13.png', TILES_DATA[13])
        tile30 = Tile(path+'14.png', TILES_DATA[14])
        tile31 = Tile(path+'15.png', TILES_DATA[15])
        ...
        self.tiles.append(tile26)
        self.tiles.append(tile27)
        self.tiles.append(tile28)
        self.tiles.append(tile29)
        self.tiles.append(tile30)
        self.tiles.append(tile31)
